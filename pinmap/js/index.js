function initialize() {
  ...
  var places = [
    ...
    {"name": "Bolton", "country": "England", "lat": 53.57686, "lng": -2.42822, "info": "<div class='caption'><h3>Bolton</h3><p class='text-justify'>Town in Greater Manchester.</p><p class='text-justify'><strong>Cool things I did here:</strong> Met an incredible family and stayed in an English Home for first time</p></div>"},
  ];

function initialize() {
  ...
  var places = [
    ...
    {"name": "Paris", "country": "France", "lat": 48.85661, "lng": 2.35222, "info": "<div class='caption'><h3>Paris</h3><p class='text-justify'>'The City of Light'. Paris is the capital of France, famous for its culture and monuments.</p><p class='text-justify'><strong>Cool things I did here:</strong> Drive a Ferrari, Eiffel Tower, Notre Dame, Triumphal Arch, Pont des Arts, Louvre Museum, Catacombs</p></div>"},
  ];
